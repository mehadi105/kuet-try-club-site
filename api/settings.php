...
function defaultSiteSettings(): array
{
    return [
        ...
        'spotlight_subtitle' => 'Highlighted stories and impact snapshots (keep short and visual).',
...
function siteSettingsGroups(): array
{
    return [
        ...
        [
            ...
            'description' => 'Heading text above spotlight mini-cards.',
            'preview' => '../index.html#spotlight',
            'managed_elsewhere' => 'Spotlight card content is managed under Admin → Spotlight.',
            'fields' => [
                field('spotlight_title', 'Section title', 'text', 'Heading for the spotlight grid.', 'Homepage → #spotlight title', 'Spotlight'),
                field('spotlight_subtitle', 'Section subtitle', 'textarea', 'Short line under the spotlight heading.', 'Homepage → #spotlight subtitle', ''),
            ],
        ],
        [
            'id' => 'inspiration',
